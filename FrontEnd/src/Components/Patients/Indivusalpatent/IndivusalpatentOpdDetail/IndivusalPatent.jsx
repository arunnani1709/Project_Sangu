...
import OpdDoctorNotes from "../Opddoctorsnote/opddoctorsnote";
...
const PatientDetails = () => {
  ...
  const handleMoveToIP = () => {
    navigate(`/ip-patient/${patient.clinicId}`, { state: { patient } });
  };
  ...
  return (
    <div className="p-8 mx-auto w-full max-w-[1100px]">
      ...
      <OpdDoctorNotes clinicId={patient.clinicId} />
    </div>
  );
};
